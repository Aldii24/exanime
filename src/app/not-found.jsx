    ...
    <>
      <div className="flex justify-center min-h-screen max-w-xl mx-auto items-center">
        <div className="flex justify-center flex-col items-center">
          <h1 className="text-5xl font-bold text-color-papaya mb-4">404</h1>
          <div className="flex flex-row">
            <FileSearch className="text-color-papaya" size={48} />
            <h1 className="text-5xl font-bold text-color-papaya">NOT FOUND</h1>
          </div>
